 ...
 * Запуск: php install/migrate_v13.php
 */
...
$sqlFile = $isSqlite ? $base . '/database/migration_v13_review_request.sqlite.sql' : $base . '/database/migration_v13_review_request.sql';
