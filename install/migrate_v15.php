<?php
/**
 * Миграция v15: user_id в таблице notifications
 * Запуск: php install/migrate_v15.php
 */
...
$sqlFile = $isSqlite ? $base . '/database/migration_v15_notifications_user.sqlite.sql' : $base . '/database/migration_v15_notifications_user.sql';
